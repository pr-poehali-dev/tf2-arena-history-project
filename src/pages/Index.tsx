          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="text-2xl font-bold mb-3">Контрольные точки</h3>
            ...
            >
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="text-2xl font-bold mb-3">Захват флага</h3>
                <p className="text-muted-foreground">
            ...
            >
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="text-2xl font-bold mb-3">Доставка бомбы</h3>
                <p className="text-muted-foreground">
            ...
            <>
              <DialogHeader>
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <DialogTitle className="text-3xl">Контрольные точки</DialogTitle>
              ...
              <div className="space-y-4">
                ...
                <p className="text-foreground leading-relaxed">
                  ...
                  Инженер ставит телепорты для быстрой доставки команды, Медик накапливает Убер для решающего прорыва, 
                  а Разведчик использует двойной прыжок для быстрого захвата. Главное правило — никогда не оставляй точки без защиты!
                </p>
              </div>
            </>
          )}
            ...
            <>
              <DialogHeader>
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <DialogTitle className="text-3xl">Захват флага</DialogTitle>
              ...
              <div className="space-y-4">
                ...
                <h4 className="text-lg font-semibold text-primary">Стратегия:</h4>
                <p className="text-foreground leading-relaxed">
                  Разведчик — лучший класс для захвата благодаря скорости. Инженер ставит телепорт для быстрой доставки портфеля. 
                  Шпион маскируется под врага и крадёт портфель незаметно. Пулемётчик и Солдат защищают свой портфель от налётчиков. 
                  Медик с Убером помогает прорваться через защиту. Главное — командная работа: одни нападают, другие защищают!
                </p>
              </div>
            </>
          )}
            ...
            <>
              <DialogHeader>
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <DialogTitle className="text-3xl">Доставка бомбы</DialogTitle>
              ...
              <div className="space-y-4">
                ...
                <h4 className="text-lg font-semibold text-primary">Стратегия:</h4>
                <p className="text-foreground leading-relaxed">
                  BLU: Разведчик быстро захватывает тележку, Пулемётчик и Солдат давят вперёд, Инженер ставит телепорт для подкрепления. 
                  Медик с Убером прорывает защиту на контрольных точках. 
                  RED: Инженер ставит турель на пути тележки, Подрывник закладывает липучки, Снайпер держит дальние подходы, 
                  Шпион саботирует атаку с тыла. Главное для RED — держать оборону на контрольных точках!
                </p>
              </div>
            </>
          )}
